...
from model.w2v_discrete_bert import w2vDiscreteBert
from model.utils.config import VQ_Wav2vecHyperParam, w2v_DiscreteBERTHyperParam
...
params = w2v_DiscreteBERTHyperParam()
...
vq_w2v_encoder = Encoder(5, vq_w2v_params.feat_dim, [(10, 5), (8, 4), (4, 2), (4, 2), (4, 2)], 
                dropout_prob=vq_w2v_params.dropout_prob, w2v_large=True)
vq_w2v_context = ContextNetwork(12, vq_w2v_params.feat_dim, [(i, 1) for i in range(2, 14)], 
                            dropout_prob=vq_w2v_params.dropout_prob, w2v_large=True)
...
w2v2_model = w2vDiscreteBert(feat_extractor, context, params=params)
